...
elseif($_POST['Prijava_3']){
	...
	if($spol==0){
	 	$error="Missing sex mark. / Niste odredili spol.";
		$OK=false;
	 }
	 elseif(empty($prezime)){
	 	$error="Missing Family name. / Niste upisali Vaše prezime.";
		$OK=false;
	 }
	elseif(empty($ime)){
	 	$error="Missing Name. / Niste upisali Vaše ime.";
		$OK=false;
	 }
	 elseif(empty($nadnevak)){
	 	$error="Niste odredili nadnevak roðenja.";
	...
	// ostala provjera ----------------
	 elseif(empty($ulica)){
	 	$error="Missing Street. / Niste upisali naziv ulice.";
		$OK=false;
	 }
	 elseif(empty($grad)){
	 	$error="Missing City. / Niste upisali naziv grada/mjesta.";
		$OK=false;
	 }
	 elseif($idPosta==0){
	 	$error="Missing Postal Code. / Niste odredili poštu stanovanja.";
		$OK=false;
	 }
	 elseif($idZupanija==0){
	 ...
	 elseif(empty($telefon)){
	 	$error="Missing Phone. / Niste upisali kontakt telefon.";
		$OK=false;
	 }

<META http-equiv=Content-Type content="text/html; charset=windows-1250">
          ...
          <td align="left"><label>
			...
			<tr>
              <td align="right" valign="top" class="tekst_L"><strong>Dostavljanje radova:</strong></td>
              <td align="left" valign="top">&nbsp;</td>
            </tr>            
			<tr>
              <td align="right" valign="top" class="tekst">1. rad:</td>
              <td align="left" valign="top">&nbsp;</td>
            </tr>            
            <tr>
			...
			<tr>
              <td align="right" valign="top" class="tekst">2. rad:</td>
              <td align="left" valign="top">&nbsp;</td>
            </tr>            
            <tr>
              <td width="25%" align="right" class="tekst_S"><div align="right">Naziv priopćenja/referata:</div></td>
          	  <td align="left">
                 <label>
                <input name="radB" type="text" class="tekst" id="radB" size="65" value="<?php echo $radB?>" disabled="disabled">
                </label>
              </td>
            </tr>
            <tr>
              <td align="right" class="tekst_S"><div align="right"> Datoteka / dokument:</div></td>
            <td align="left"><label>
              <input name="fileB" onmouseover="Tip('Pritisnite kako biste poslali svoje priopčenje/referat')" onmouseout="UnTip()" type="file" id="fileB" class="tekst" size="80" />
            </label></td>
            </tr>
            <tr>
              <td class="tekst">&nbsp;</td>
            ...
            <tr>
              <td align="right" valign="middle" class="tekst">&nbsp;</td>
              <td align="left" class="tekst">
                <label><input type="radio" name="radio4B" id="radio4B" value="1" disabled="disabled" <?php echo $check_PredDaB?>/ >Da</label>
                <label><input name="radio4B" type="radio" id="radio4B" value="0" disabled="disabled <?php echo $check_PredNeB?>"/>Ne</label>
              </td>
            </tr>
            <tr>
              <td>&nbsp;</td>

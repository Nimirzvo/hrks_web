<META http-equiv=Content-Type content="text/html; charset=windows-1250">
          ...
          <table width="98%" border="0" cellspacing="0" cellpadding="2" class="tekst">
            ...
            <td align="left" valign="top" class="tekst"><label>
              ...
              <input name="idUplata" type="hidden" id="idUplata" value="<?php echo $idUplata?>" />
            ...
            <td align="left"><label>
                ...
                <a href="#" onClick="setYears(1947, 2015);showCalender(this, 'nadnevak');"><img src="css/calendar.png" onmouseover="Tip('Izaberi nadnevak')" onmouseout="UnTip()" border="0" height="16" width="16"></a>
            </label></td>
            </tr>
            <tr>
            ...
            <tr>
              <td align="right" valign="middle" class="tekst_S">Vrsta uplate:</td>
              <td align="left" class="tekst">
                <label><input type="radio" name="radio_p" id="radio_p" value="1" <?php echo $check_P?>/>Prihod (UFA)</label>
                <label><input type="radio" name="radio_p" id="radio_p" value="2" <?php echo $check_R?>/>Rashod (IFA)</label>
              </td>
            <tr>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
            ...
            <tr>
              ...
              <td>
              <input name="NovaUplata2" type="submit" class="tekst2" id="NovaUplata2" value="  Potvrdi uplatu ">&nbsp;&nbsp;&nbsp;</td>
            </tr>
            <tr>
              <td>&nbsp;</td>
              <td>&nbsp;</td>

<META http-equiv=Content-Type content="text/html; charset=windows-1250">
          ...
          <table width="98%" border="0" cellspacing="0" cellpadding="2" class="bg">
            ...
            Brisanjem odabranih skupova obrisat će se i svi podatci o prijavama odabranih skupa.</label></td>
            </tr>
            <tr>
              <td width="25%" class="tekst"><div align="right">&nbsp;</div></td>
            <td align="left" valign="top" class="tekst2">Želite li obrisati odabrane skupove?</td>
            </tr>
            <tr>
              <td>&nbsp;</td>
              <td>&nbsp;</td>

<META http-equiv=Content-Type content="text/html; charset=windows-1250">
          ...
          <table width="98%" border="0" cellspacing="0" cellpadding="2" class="tekst">
            ...
            <tr>
              <td align="right" class="tekst_S">Prezime i ime:</td>
              <td align="left" valign="top"><?php echo $ime?></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
            ...
            <td align="left"><label>
                ...
                <a href="#" onClick="setYears(1947, 2010);showCalender(this, 'nadnevak');"><img src="css/calendar.png" onmouseover="Tip('Izaberi nadnevak')" onmouseout="UnTip()" border="0" height="16" width="16"></a>
            </label></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>
              <input name="NovaUplata" type="submit" class="tekst2" id="NovaUplata" value="  Potvrdi uplatu ">&nbsp;&nbsp;&nbsp;
              <input name="BrisiUplatu" type="submit" class="tekst2" id="BrisiUplatu" value="  Obri&scaron;i uplatu ">
 			  </td>
            </tr>
            <tr>
              <td>&nbsp;</td>

...
$selectA_0="selected"; $selectA_1="";$selectA_2="";$selectA_3="";$selectA_4="";
$selectB_0="selected"; $selectB_1="";$selectB_2="";$selectB_3="";$selectB_4="";$selectB_5="";
$selectC_0="selected"; $selectC_1="";$selectC_2=""; $selectC_3="";
$OK=true;
session_start();
...
if($_POST['Submit_5']){
		header("Location: pregled_radova_domaci.php?idSkup=$idSkup"); 
		exit();
}
elseif($_POST['filter']){
		$radioF=$_POST["radioF"];
...
<table width="875" border="0" align="center" class="okvir">
  <tr>
    ...
    <td align="left" valign="top"><table width="100%"  border="0">
      ...
      <tr>
        <td height="3" colspan="2" class="tekst">&nbsp;<strong>Domaæi skup</strong></td>
      </tr>
      <tr>
                ...
                <tr align="left">
                  <td colspan="6">&nbsp;&nbsp;<input type="radio" name="radioF" id="radioF" value="1"<?php echo $check_F1?>>
                    Prema vrsti ustanove: 
                      <select name="skola" class="tekst" id="skola">
                      <option value="0" <?php echo $selectA_0 ?>>-</option>
                      <option value="1" <?php echo $selectA_1 ?>>Osnovna škola</option>
                      <option value="2" <?php echo $selectA_2 ?>>Srednja škola</option>
                      <option value="3" <?php echo $selectA_3 ?>>Visoko školstvo</option>
                      <option value="4" <?php echo $selectA_4 ?>>Ostale ustanove</option>
                    </select></td>
                </tr>
                <tr align="left">
                  <td colspan="6">&nbsp;&nbsp;<input type="radio" name="radioF" id="radioF" value="2"<?php echo $check_F2?>>
                    Imaju prijavljen rad:
                      <select name="sudjelovanje" class="tekst" id="sudjelovanje">
                      <option value="0" <?php echo $selectB_0 ?>>  -   </option>
                      <option value="1" <?php echo $selectB_1 ?>>  Da  </option>
                      <option value="2" <?php echo $selectB_2 ?>>  Ne  </option>
                    </select></td>
                </tr>
                <tr align="left">
                  <td colspan="6">&nbsp;&nbsp;<input type="radio" name="radioF" id="radioF" value="3" <?php echo $check_F3?>>
                  Pregled prezentacija radova: 
                      <select name="sekcija" class="tekst" id="sekcija">
                      <option value="0" <?php echo $selectC_0 ?>>-</option>
                      <option value="1" <?php echo $selectC_1 ?>>Svi radovi</option>
                      <option value="2" <?php echo $selectC_2 ?>>Radovi koji se prezentiraju</option>
                      <option value="3" <?php echo $selectC_3 ?>>Radovi koj se NE prezentiraju</option>
                    </select></td>
                </tr>
      			<tr>
        			<td height="1" colspan="2" class="linija"><img src="../image/linija_horiz.gif" width="3" height="1"></td>
                ...
                <?php
					switch($izbor){
						case 1:
							...
							break;
						case 2:
							include ($body."/pregledDetaljiPrijava.php");
							break;
						case 3:
						...
						case 5:
							...
							break;
						case 6: // filtriranje
							include ($body."/pregledPrijavljenihOsoba_D_Filter.php");
							break;
						default:
							include ($body."/pregledPrijavljenihOsoba.php");
							break;

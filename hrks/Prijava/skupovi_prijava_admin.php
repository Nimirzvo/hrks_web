...
*/	 
	 if($OK){
		 ...
		 $data=odredi_osobu($_POST['ime'],$_POST['prezime'],$nadnevak);
		 //echo "Datum : ".$nadnevak. " <br>";
		 // punimo varijable s podacima
		 // $idOsoba=0;
		   $ulica=""; $grad=""; $idPosta="0"; $idZupanija="0"; $telefon=""; $email=""; $spol=""; $idTitula="0"; $institucija="";
		...
		//echo "Datum2 : ".$nadnevak. " <br>";
		// provjerimo da li je upisani podaci o referatu
		$idRef=odredi_referat_ID_2($idOS, $idSkup);
		if($idRef>0){
			$check_refDa="checked";
			$check_refNe="";
			$vrstaRef=odredi_referat_ID_3($idOS, $idSkup);
			$nazivRef=odredi_referat_Naziv($idRef);
			$os_pre=odrediReferat_Osoba_Predaje($idSkup, $idOS);
			if($os_pre==0){
				$check_PredDa="";
				$check_PredNe="checked";
			}
			else{
				$check_PredNe="";
				$check_PredDa="checked";
			}
			//check_PredDa
			// znaèi da imamo podatke o prijavi referata
				if($vrstaRef==1){
					$check_prviAutor="checked";
					$check_drugiAutor="";
					$rad=$nazivRef;
					$radKo="";
				}
...
// provjera da li je odreðena osoba za upis i da li postoji upis

if($idOsoba>0 && !$_POST['Prijava_1'] && !$_POST['Prijava_2'] && !$_POST['Prijava_3']){
  ...
  <tr>
    ...
    <td align="left" valign="top"><table width="100%"  border="0">
      ...
      <tr align="left" valign="middle">
        <td height="12" colspan="2" class="meni" >&nbsp;<img src="../image/kucica.gif" width="15" height="10" border="0">&nbsp;<a href="skupovi_pregled.php?idSkup=<?php echo $idSkup ?>" class="meni">Otvaranje skupa</a>::Prijava</td>
      </tr>
      <tr>

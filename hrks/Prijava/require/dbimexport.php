...
class dbimexport
{
            ...
            while ( $row = mysql_fetch_assoc ( $rows ) )
            {
                ...
                foreach( $row as $key => $val )
                {
                    ...
                    else
                    {
						...
						$cdataNode = $dom->createCDATASection($this->text2normalizeXXX($val));
	...
	function text2normalize($str = "")
   {
    ...
    function text2normalizeXXX($str = "")
    {
        $arr_busca = array('c','C','c','C','ž','Ž','š','Š','d', 'Ð','è','ê','É','È','Ê','í','ì','î','Í','Ì','Î','ò','ó','ô', 'õ','º','Ó','Ò','Ô','Õ','ú','ù','û','Ú','Ù','Û','ç','Ç','Ñ','ñ');
        $arr_susti = array('c','C','c','C','ž','Ž','š','Š','d','Ð','e','e','E','E','E','i','i','i','I','I','I','o','o','o','o','o','O','O','O','O','u','u','u','U','U','U','c','C','N','n');
        return trim(str_replace($arr_busca, $arr_susti, $str));
    }
}
?>